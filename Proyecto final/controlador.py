...
URL_DEL_JSON_DE_CLIENTES  = "https://invalid-url-to-force-local-fallback.com/clientes.json"
...
class MaquinaExpendedora:
    ...
    def cargar_lista_de_tarjetas(self):
        """
        Carga los datos de clientes directamente desde el archivo JSON local.
        """
        print("  Cargando clientes desde archivo local...")
